...
from utils.config import SIMULATION_TEST_OUTPUT_FOLDER_TDB_2
from utils.config import LATENT_OUTPUT_TDB
...
path_output=SIMULATION_TEST_OUTPUT_FOLDER_TDB_2  # for thinner, denser branches 
...
with open(LATENT_OUTPUT_TDB,'wb') as file:
