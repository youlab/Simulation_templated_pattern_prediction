...
from utils.config import SIMULATION_AUGMENTATION_BASE_TDB
...
entries = [d for d in os.listdir(SIMULATION_AUGMENTATION_BASE_TDB) if pattern.fullmatch(d)]
...
path_output=os.path.join(SIMULATION_AUGMENTATION_BASE_TDB, foldername)
...
latentname=f'latent_dim_AugmentedDataDemand_4channels_4x32x32_{unique_samples[taskID-1]}_complex_{currentMonth}{currentDay}.pickle'
