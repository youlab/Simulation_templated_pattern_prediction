...
%     Pattern_Generator(param_vector_2,Pattern,newnumber,tag2)
    Pattern_Generator(param_vector_2,Pattern,newnumber,tag2,taskID)
    Pattern_Generator(param_vector_3,Pattern,newnumber,tag3,taskID)
...
function Pattern_Generator(param_vector,Pattern1,newnumber,tag,t)




 load('designs_24_10_02.mat') % load the matrix
...
%         t=1;
        ...
        % 
           ...
           base_name_output='/hpc/group/youlab/ks723/storage/MATLAB_SIMS/Sim_050924_ModelTesting';
...
% 
    ...
    %         base_name_timepoint=strcat('Tp',num2str(i));
        ...
        %     base_name_output='/hpc/group/youlab/ks723/storage/MATLAB_SIMS/Sim_040423_100pointgrid/Sim_input'; 
            filename_output=strcat('Output','_',num2str(t),'.png')  ; % here t is the ith image in the test folder
...
%     %         base_name_input='C:\Users\kinsh\Documents\MATLAB\OptimalPatterns_NanLuo-master\OptimalPatterns_NanLuo-master\Pattern_prediction\Sim_output_simple';
    ...
    %         base_name_output=fullfile(base_name_input,base_name_timepoint);
            ...
            base_name_input='/hpc/group/youlab/ks723/storage/MATLAB_SIMS/Sim_050924_ModelTesting/Sim_output';
%               base_name_input='C:\Users\kinsh\Documents\MATLAB\OptimalPatterns_NanLuo-master\OptimalPatterns_NanLuo-master\Pattern_prediction\Sim_050924\Sim_output';
            ...
            filename_input=strcat('Input','_',num2str(t),'.png');
