...
for t=1:10   % since this varies between 1 to 10 total variation is bw 1 to 1000
...
%     Density=0.47;
    ...
    switch config
        ...
        case 17; Pattern= simPatterns(:,:,(10*(taskID-1)+t));
...
%         base_name_timepoint=strcat('Tp',num2str(i));
          ...
          base_name_iteration=10*(taskID-1)+t;
...
%         base_name_output=fullfile(base_name_output,'Sim_input',base_name_iteration);
    ...
    %     base_name_output='/hpc/group/youlab/ks723/storage/MATLAB_SIMS/Sim_040423_100pointgrid/Sim_input'; 
        filename_output=strcat('Output','_',num2str(base_name_iteration),'.png')  ; % here t is the value of iteration 
...
%           base_name_input='C:\Users\kinsh\Documents\MATLAB\OptimalPatterns_NanLuo-master\OptimalPatterns_NanLuo-master\Pattern_prediction\Sim_031424\Sim_output';
        ...
        filename_input=strcat('Input','_',num2str(base_name_iteration),'.png'); %'_', ,num2str(time_month),'_',num2str(time_day)
